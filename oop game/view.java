...
import java.util.Collections;
    ...
    public class view {
        ...
        private static String getChar(int x, int y){
            ...
            for (Unit human: main.team3) {
                if (human.getCoords()[0] == x && human.getCoords()[1] == y){
                    ...
                    if (main.team2.contains(human)) out = "|" + (AnsiColors.ANSI_GREEN + human.getInfo().charAt(0) + AnsiColors.ANSI_RESET);
                    if (main.team1.contains(human)) out = "|" + (AnsiColors.ANSI_BLUE + human.getInfo().charAt(0) + AnsiColors.ANSI_RESET);
                    break;
                }
            }
            return out;
        ...
        public static void view() {
            ...
            step++;
            main.team3.forEach((v) -> l[0] = Math.max(l[0], v.toString().length()));
